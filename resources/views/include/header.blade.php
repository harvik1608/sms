...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('tega/favicon-16x16.png') }}">
                ...
                <div class="main-header">
                    <div class="header-left active">
                        <a href="{{ route('admin.dashboard') }}" class="logo logo-normal">
                            <img src="{{ asset('tega/logo.jpg') }}" alt="Img">
                        </a>
                        <a href="{{ route('admin.dashboard') }}" class="logo logo-normal">
                            <img src="{{ asset('assets/img/logo-white.svg') }}" alt="Img">
                        </a>
                        <a href="{{ route('admin.dashboard') }}" class="logo logo-normal">
                            <img src="{{ asset('tega/small_logo.jpg') }}" alt="Img">
                        </a>
                    </div>
