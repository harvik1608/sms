...
<form action="{{ is_null($state) ? url('states') : url('states/'.$state->id) }}" method="POST" enctype="multipart/form-data" id="mainForm">
    @csrf
    @if(!is_null($state))
                ...
                <div class="card-body profile-body">
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="name" id="name" value="{{ is_null($state) ? '' : $state->name }}" />
                        </div>
                        <div class="col-lg-12 mb-3">
                    ...
                    <div class="text-end mt-2">
                        ...
                        <a href="{{ url('states') }}" class="btn btn-secondary" id="backBtn">Back</a>
                    </div>
                </div>
            </div>
        </div>
