...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4 class="fw-bold">City List</h4>
            <h6></h6>
        </div>
    </div>
    <div class="page-btn">
        <a href="{{ url('cities/create') }}" class="btn btn-primary text-white"><i class="ti ti-circle-plus me-1"></i> New City</a>
    </div>
</div>
<div class="card">
